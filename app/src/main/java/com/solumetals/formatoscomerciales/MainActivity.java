...
public class MainActivity extends Activity {
    ...
    void createPdf(boolean share){
        ...
        if(!card){p.setColor(Color.GRAY);p.setTextSize(7);c.drawText("Formatos Comerciales",30,H-12,p);}doc.finishPage(page);int n=prefs.getInt("seq_"+currentType,1);
